...
# usage:
$ python training_model.py big-data/moses_dataset/result/step2_parallel_frag_smiles_sentence.csv big-data/moses_dataset/result/
...
def train_model(train_x_fp, model_fp):
    ...
    model = fasttext.train_unsupervised(train_x_fp, model='cbow', dim=100, ws=5, thread=4, epoch=10, minCount=3)
...
if __name__ == '__main__':
    ...
    if supervised_training:
        ...
        # x = frag2vec.values
        frag2class = get_class(frag_info)
