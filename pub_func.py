...
class Mol2Network:
    def __init__(self, n2n, id2smiles):
        """
        represent a molecule by graph
        :param n2n: node to neighbors (node id and it's neighbors)
        - {1: [12], 2: [12], 3: [8, 12], 4: [5, 8], 5: [4, 6], 6: [5, 9], 7: [9, 10],
           8: [3, 4], 9: [6, 7, 11], 10: [7], 11: [9], 12: [1, 2, 3]}
        :param id2smiles:
        """
        self.n2n = n2n
    ...
    def get_mol_path(self):
        """
        get molecular skeleton (the longest path among all the possible shortest path between two terminal fragments)
        and attached the most branch neighbors
        :return:
        """
