...
# refragment
# python refragment.py big-data/moses_dataset/result/step1_result.txt big-data/moses_dataset/result/
# --log_fn big-data/moses_dataset/result/step2_log.log --refragment
# --frag2num_fp big-data/moses_dataset/result/step1_frag2num.csv --arrangement_mode parallel
"""
import os
import json
import argparse
...
from helper_func import replace_smiles_by_frag_id, count_fragment, Refragment
...
if __name__ == '__main__':
    ...
    replace_smiles_by_frag_id(result_file_frag2num, result_file_cid2frag,
